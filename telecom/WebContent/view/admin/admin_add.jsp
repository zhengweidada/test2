   ...
   function showResultDiv(flag) {
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath }/admin/addAdminServlet" method="post" class="main_form" enctype="multipart/form-data">
                    ...
                    <div class="input_info">
                        <input type="text" name="admin_loginname"/>
                        <span class="required">*</span>
                        <div class="validate_msg_long">30长度以内的字母、数字和下划线的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>密码：</span></div>
                    <div class="input_info">
                        <input type="password" name="admin_psw"/>
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg">30长度以内的字母、数字和下划线的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>重复密码：</span></div>
                    <div class="input_info">
                        <input type="password" name="admin_rpsw"/>
                        <span class="required">*</span>
                    ...
                    <div class="input_info">
                        <input type="text" class="width200" name="admin_phone"/>
                        <span class="required">*</span>
                        ...
                        <div class="input_info_scroll">
                            <ul>
                            	<c:forEach items="${sessionScope.rlist }" var="roles">
                            		<li><input type="checkbox" name="permissions" value="${roles.getRole_id() }"/>${roles.getRole_name()}</li>								
